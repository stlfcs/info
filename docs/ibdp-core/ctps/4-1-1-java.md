...
The class name needs to be declared as `public` so it can be accesses from outside the class to create objects from it, and also needs the `class` declaration in it.
